...
$queuePath=Join-Path $resolvedOutput "rmk_ordered_payload_queue_v3.csv"
...
$manifest=[ordered]@{
    schema="rmk-ordered-payload-queue/v3";generated_at=(Get-Date -Format o);
...
$manifestPath=Join-Path $resolvedOutput "rmk_ordered_payload_queue_v3_manifest.json"
